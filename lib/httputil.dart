...
class HttpUtils {
  static const String BaseUrl = 'https://api.data.gov.sg/v1/transport/carpark-availability';
  static const String FormatUrl = 'json';
  static const String Carparks = 'carpark/list/';
  ...
  static getUrl({String carpark}){
    return BaseUrl+carpark+FormatUrl;
  }
}
